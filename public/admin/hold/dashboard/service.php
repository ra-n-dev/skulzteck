           ...
           <li class="nav-item doit" >
                  ...
                  <div class="dropdown" style="width:100%; background: transparent;">
                   ...
                   <ul class="dropdown-menu menuu" >
                    ...
                    <a href="drug_list.php" ><li id="wok" ><i data-feather="shopping-cart" id="aaa"></i>drug</li></a>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 ">
      ...
      <div class="card shadow mb-4">
       ...
       <div class="card-header py-3" style="margin-bottom: 2%;">                          
         <a href="#" style="text-decoration:none;font-size: 25px;" class="m-0 font-weight-bold co">Our services</a>
                 ...
                 echo"</tbody";        
                  ...
                  $query ="SELECT * FROM services_table" ;
                    ...
                    if(mysqli_num_rows($result)<1){
                     ...
                     while ($row= mysqli_fetch_array($result)) {
                            $id =$row['services_id'];
                            $createdate = $row['services_id'];
                            $service = $row['category'];
                            $price = $row['price'];
                            $work_days = $row['working_days'];
                            $work_hours = $row['working_hours'];
                       echo"<tbody>";
                       echo "<tr>
                       <td style=' padding-left:5px;padding-right:5px; width:20%'>$createdate</td>

                        <td style='padding-left:5px;padding-right:5px; width:30% '>$service</td>
                        <td style=' padding-left:5px;padding-right:5px;width:25% '>$price</td>
                        <td style=' padding-left:5px;padding-right:5px; width:25% '>$work_days</td> 
                        <td style=' padding-left:5px;padding-right:5px; width:25% '>$work_hours</td> 
                        <td style='width:1%'>
                            <span style='margin-left:20%'>

                            <a href='service.php?delete= ".$row['services_id']." '  data-toggle='modal' data-target='#product_view".$row['services_id']."' style='text-decoration:none'> 
                            ...
                            <div class='modal fade ad' id='product_view".$row['services_id']."' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel'aria-hidden='true'>
                                    ...
                                    <div class='modal-body'>
                                            <p>Please are you sure you want to delete  $service </p>
                                    ...
                                    <div class='modal-footer subb '>
                                        ...
                                        <a href='service.php? delete=$id ' class='canc' id='www'>Delete</a>
                                    </div>
                                    </div>
                                </div>
                         </div>
                             ...
                             <a href='service.php?update =".$row['services_id']."'
                        ...
                        <div class='modal-dialog' role='document'>
                             <div class='modal-content'>
                                ...
                                <form method='POST' enctype='multipart/form-data'>
                                    ...
                                    <input type='text' name='category' value ='$service'><br>
                                    <label>Price</label><br>
                                    <input type='text' name='price'  value='$price'><br>
                                    <label>Working Days</label><br>
                                    <input type='text' name='working_days' value ='$work_days'><br>
                                    <label>Working Hours</label><br>
                                    <input type='text' name='working_hours' value ='$work_hours'>
