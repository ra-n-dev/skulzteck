    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 ">
      ...
      <div class="card shadow mb-4">
       ...
       <div class="card-header py-3" style="margin-bottom: 2%;">                          
         <a href="#" style="text-decoration:none;font-size: 25px;" class="m-0 font-weight-bold co">Expenditure</a>
      ...
      <div class="table-responsive " style="display: block;">
        ...
        <?php
            if(isset($_POST['sort'])){
                ...
                $query ="SELECT * FROM expenditure_table WHERE expense_date  BETWEEN '$startdate' AND '$enddate'  " ;
                $result =mysqli_query($connect, $query);
       
                echo"<table class='table table-bordered' id='example' width='100%' cellspacing='0' table-striped table-sm>
                      <thead>
                      <tr >
                         <th style='' >Expense Date</th>
                         <th style='' >Spender Name</th>
                         <th style='' >Details</th>
                         <th style='' >Amount</th>
                         <th style='' >Department</th>
                         <th style='' >Accountant</th>
                      </tr>
                      </thead>
                     ";
                    if(mysqli_num_rows($result)<1){
                      echo"<tr><td style=' border: 0pt double ;background:white;color:black;'>No expenses statement data for the sorted period</<td></tr>";
                      }
                     ...
                     while ($row= mysqli_fetch_array($result)) {
                            ...
                            $department =$row['spender_department'];
                            $accountant =$row['accountant_name'];
                       echo"<tbody>";
                       echo "<tr>
                       <td style=' padding-left:5px;padding-right:5px;'>$expensedate</td>

                        <td style='padding-left:5px;padding-right:5px;'>$spendername</td>
                        <td style=' padding-left:5px;padding-right:5px;'>$details</td>
                        <td style=' padding-left:5px;padding-right:5px;'>$amount</td> 
                        <td style=' padding-left:5px;padding-right:5px;'>$department</td>
                        <td style=' padding-left:5px;padding-right:5px;'>$accountant</td>         
                    </tr>";              
                 echo"</tbody";        
                }
                  ...
                  $query ="SELECT * FROM expenditure_table" ;
                     ...
                     ";
                    if(mysqli_num_rows($result)<1){
                      echo"<tr><td style=' border: 0pt double ;background:white;color:black;'>No data for expenses statement</<td></tr>";
                      }
