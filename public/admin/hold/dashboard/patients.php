    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-0 pb-0 mb-3 border-bottom">
       ...
       <div class="card-header py-3" style="margin-bottom: 2%;">                          
         <a href="#" style="text-decoration:none;font-size: 25px;" class="m-0 font-weight-bold co">CCCL Patients</a>
      ...
      <div class="table-responsive" style="display: block;">
        ...
        <?php
            if(isset($_POST['sort'])){
                ...
                $query ="SELECT * FROM patient_table WHERE pay_date  BETWEEN '$startdate' AND '$enddate'  " ;
                  ...
                  $query ="SELECT * FROM patient_table" ;
                    ...
                    if(mysqli_num_rows($result)<1){
                     ...
                     while ($row= mysqli_fetch_array($result)) {
                       ...
                       echo"<tbody>";
                       echo "<tr>
                       <td style=' padding-left:5px;padding-right:5px; width:20%'>$regdate</td>

                        <td style='padding-left:5px;padding-right:5px; width:30% '>$patientname</td>
                        <td style=' padding-left:5px;padding-right:5px;width:25% '>$contact</td>
                        <td style=' padding-left:5px;padding-right:5px; width:25% '>$occupation</td>
                        <td style=' padding-left:5px;padding-right:5px; width:25% '>$nationality</td> 
                        <td style=' padding-left:5px;padding-right:5px; width:25% '>$gender</td>           
                    </tr>";              
                 echo"</tbody";        
                }
                  echo "<tbody></tbody></table>";
