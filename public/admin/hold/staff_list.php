            ...
            <div id="content" >
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a href="#" style="text-decoration:none;font-size: 25px;" class="m-0 font-weight-bold text-primary">CCCL Staff</a>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <?php 
                                 ...
                                 while($row =mysqli_fetch_array($ans)){
                                    ...
                                    <tbody>
                                    <tr>
                                <td data-href='staff_profile.php?id =$id' style='width:1%'target='profile'>$id</td>
                            ...
                            <a href='staff_list.php?delete= ".$row['id']." '  data-toggle='modal' data-target='#product_view".$row['id']."' style='text-decoration:none'> 
                  ...
                  <a href='staff_list.php?update =".$row['id']."'
