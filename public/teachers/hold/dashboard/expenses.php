    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="card shadow mb-4">
       ...
       <div class="card-header py-3" style="margin-bottom: 2%;">                          
         <a href="#" style="text-decoration:none;font-size: 25px;" class="m-0 font-weight-bold co">CCCL Expenses </a>
                ...
                echo"<table class='table table-bordered' id='example' width='100%' cellspacing='0' table-striped table-sm>
                 ...
                 echo"</tbody";        
                  ...
                  $query ="SELECT * FROM expenditure_table" ;
                     ...
                     ";
                    if(mysqli_num_rows($result)<1){
                      echo"<tr><td style=' border: 1pt double ;background:white;color:black;'>No data for expenses schedule</<td></tr>";
                      }

                     while ($row= mysqli_fetch_array($result)) {
                            $spenddate = $row['expense_date'];
                       ...
                       echo"<tbody>";
                       echo "<tr>
                       <td style=' padding-left:5px;padding-right:5px; width:20%'>$spenddate</td>
                        ...
                        <td style=' padding-left:5px;padding-right:5px;width:25% '>$accountant</td>
