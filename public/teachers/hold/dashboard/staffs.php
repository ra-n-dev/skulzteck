    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 ">
      ...
      <div class="card shadow mb-4">
       ...
       <div class="card-header py-3" style="margin-bottom: 2%;">                          
         <a href="#" style="text-decoration:none;font-size: 25px;" class="m-0 font-weight-bold co">CCCL Staffs</a>
                ...
                echo"<table class='table table-bordered' id='example' width='100%' cellspacing='0' table-striped table-sm>
                    ...
                    if(mysqli_num_rows($result)<1){
                     ...
                     while ($row= mysqli_fetch_array($result)) {
                       ...
                       echo"<tbody>";
                       echo "<tr>
                       <td data-href='staff_profile.php?id =$id' style='width:1%'target='profile'>$paydate</td>
                       <td data-href='staff_profile.php?id=$id' style='width:35%'>$staff_name</td>
                       <td data-href='staff_profile.php?id=$id' style='width:22%'>$role</td>
                       <td data-href='staff_profile.php?id=$id' style='width:20%'>$qualification</td>
                       <td data-href='staff_profile.php?id=$id' style='width:21%' >$contact</td>
                       <td style='width:1%'>         
                    </tr>";              
                 echo"</tbody";        
                }
                  ...
                  $query ="SELECT * FROM staff_table" ;
                      ...
                      <thead>
                          <tr>
                            <th style='width:1%'>Resumed Date</th>
                            <th style='width:35%'>Name of Staff</th>
                    ...
                    if(mysqli_num_rows($result)<1){
                     ...
                     while ($row= mysqli_fetch_array($result)) {
                       ...
                       echo"<tbody>";
                       echo "<tr>
                          <td data-href='staffs_profile.php?id =$id' style='width:1%'target='profile'>$date_employed</td>
                          <td data-href='staffs_profile.php?id=$id' style='width:35%'>$staff_name</td>
                          <td data-href='staffs_profile.php?id=$id' style='width:22%'>$role</td>
                          <td data-href='staffs_profile.php?id=$id' style='width:20%'>$qualification</td>
                          <td data-href='staffs_profile.php?id=$id' style='width:21%' >$contact</td>
                          <td style='width:1%'>
                            <span style='margin-left:20%'>

                          <a href='staffs.php?delete= ".$row['id']." '  data-toggle='modal' data-target='#product_view".$row['id']."' style='text-decoration:none'> 
                       ...
                       <div class='modal fade ad' id='product_view".$row['id']."' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel'aria-hidden='true'>
                                    ...
                                    <div class='modal-body'>
                                            <p>Please are you sure you want to delete  $staff_name </p>
                                            <p> from Classic Care Clinic staffs? </p>
                                           
                                    </div>
                                    <div class='modal-footer subb '>
                                        <input type='button' value ='Back' class='pro' data-dismiss='modal' id='ww'>
                                        <a href='staff.php? delete=$id ' class='canc' id='www'>Delete</a>
                                    </div>
                                    </div>
                             </div>
                    </div>
                        ...
                        <a href='staffs.php?update =".$row['id']."'
                             data-toggle='modal' data-target='#approve_view".$row['id']."'>
                             <i class='fas fa-edit fa-1x'style='color:green;text-decoration:none'></i>
                        </a>



                    <div class='modal fade adx' id='approve_view".$row['id']."' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel'aria-hidden='true'>
                        <div class='modal-dialog' role='document'>
                             <div class='modal-content'>
                                <div class='modal-header hed'>
                                 <h5 class='modal-title ' id='exampleModalLabel' style='color:red; font-family: monospace;'>!!! Warning: Admin  $uname
                                ...
                                <form method='POST' enctype='multipart/form-data'>
                                    ...
                                    <input type='text' name='category' value ='$staff_name'><br>
                                    <label>Price</label><br>
                                    <input type='text' name='price'  value='$role'><br>
                                    <label>Working Days</label><br>
                                    <input type='text' name='working_days' value ='$qualification'><br>
                                    <label>Working Hours</label><br>
                                    <input type='text' name='working_hours' value ='$contact'>
                             ...
                             <?php 
                                ...
                                if(isset($_POST['update'])){
                                    ...
                                    $que ="UPDATE staff_table SET username ='$staff_name', usertype ='$role', qualification='$qualification', contact='$contact' WHERE id ='$idd' ";

                                    $resultt = mysqli_query($connect,$que) or die(mysqli_error($connect));

                                    echo "<script>window.location.href='../admin2/staff.php'</script>";
