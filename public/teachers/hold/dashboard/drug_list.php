    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 ">
      ...
      <div class="card shadow mb-4">
       ...
       <div class="card-header py-3" style="margin-bottom: 2%;">                          
         <a href="#" style="text-decoration:none;font-size: 25px;" class="m-0 font-weight-bold co">Drugs</a>
            ...
            if(isset($_POST['sort'])){
                ...
                echo"<table class='table table-bordered' id='example' width='100%' cellspacing='0' table-striped table-sm>
                    ...
                    if(mysqli_num_rows($result)<1){
                      echo"<tr><td style=' border: 0pt double ;background:white;color:black; width=100%'>No data for Income schedule</<td></tr>";
                      }
