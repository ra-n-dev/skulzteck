...
// getting the monthly drugs expenses
   ...
   //$monthly_net =$sum - $month_expenses
     ...
     if(isset($_GET['approve'])){
             ...
             echo "<script>window.location.href='../dashboard/requested_expenses.php'</script>";
 }
...
<html lang="en">
  <head>
    ...
    <title>CCCL Requested Expenses</title>
            ...
            if(isset($_POST['sort'])){
                ...
                echo"<table class='table table-bordered' id='example' width='100%' cellspacing='0' table-striped table-sm>
                 ...
                 echo"</tbody";        
                  ...
                  $query ="SELECT * FROM expenditure_request_table WHERE request_date BETWEEN '$first' AND '$last' AND request_status ='pending' " ;
                                $result =mysqli_query($connect, $query);
                       ...
                       <td style=' padding-left:5px;padding-right:5px; width:20%'>$request_date</td>
                        ...
                        <td style='width:1%'>
                            ...
                            <div class='modal fade ad' id='product_view".$row['ex_id']."' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel'aria-hidden='true'>
                             ...
                             <a href='requested_expenses.php?update =".$row['ex_id']."'
